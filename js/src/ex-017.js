import { toRoman } from '../src/ex-017.js'
...
describe('toRoman()', () => {
  ...
  test('converts 16', () => expect(toRoman(16)).toEqual('XVI'))
  ...
  test('converts 66', () => expect(toRoman(66)).toEqual('LXVI'))
  ...
  test('converts 166', () => expect(toRoman(166)).toEqual('CLXVI'))
  test('converts 402', () => expect(toRoman(402)).toEqual('CDII'))
  test('converts 575', () => expect(toRoman(575)).toEqual('DLXXV'))
  test('converts 666', () => expect(toRoman(666)).toEqual('DCLXVI'))
  test('converts 911', () => expect(toRoman(911)).toEqual('CMXI'))
  test('converts 1024', () => expect(toRoman(1024)).toEqual('MXXIV'))
  test('converts 1666', () => expect(toRoman(1666)).toEqual('MDCLXVI'))
  test('converts 3000', () => expect(toRoman(3000)).toEqual('MMM'))
  test('converts 3001', () => expect(toRoman(3001)).toEqual('MMMI'))
  test('converts 3999', () => expect(toRoman(3999)).toEqual('MMMCMXCIX'))
})
