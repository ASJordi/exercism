...
public class AnagramTest {
    ...
    public void testDetectMultipleAnagrams() {
        ...
        assertThat(detector.match(Arrays.asList("stream", "pigeon", "maters"))).containsExactlyInAnyOrder("maters", "stream");
    }
    ...
    public void testDetectLongerAnagram() {
        ...
        assertThat(detector.match(Arrays.asList("enlists", "google", "inlets", "banana"))).containsExactlyInAnyOrder("inlets");
    }
    ...
    public void testDetectsMultipleAnagramsWithDifferentCase() {
        ...
        assertThat(detector.match(Arrays.asList("Eons", "ONES"))).containsExactlyInAnyOrder("Eons", "ONES");
    }
    ...
    public void testCaseInsensitiveWhenSubjectStartsWithUpperCaseLetter() {
        ...
        assertThat(detector.match(Arrays.asList("cashregister", "carthorse", "radishes"))).containsExactlyInAnyOrder("carthorse");
    }
    ...
    public void testWordsOtherThanThemselvesCanBeAnagrams() {
        ...
        assertThat(detector.match(Arrays.asList("Listen", "Silent", "LISTEN"))).containsExactlyInAnyOrder("Silent");
    }
