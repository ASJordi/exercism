...
class FighterTest {
    ...
    void testWarriorClassExists() {
        try {
            Class.forName("easy.wizardwarrior.Warrior");
    ...
    void testWarriorIsInstanceOfFighter() throws ClassNotFoundException {
        assertThat(Class.forName("easy.wizardwarrior.Warrior")).isAssignableTo(Fighter.class);
    }
    ...
    void testWizardClassExists() {
        try {
            Class.forName("easy.wizardwarrior.Wizard");
        } catch (ClassNotFoundException e) {
    ...
    void testWizardIsInstanceOfFighter() throws ClassNotFoundException {
        assertThat(Class.forName("easy.wizardwarrior.Wizard")).isAssignableTo(Fighter.class);
    }
